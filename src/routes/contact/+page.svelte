...
<section class="max-w-2xl mx-auto py-16 px-6 min-h-screen bg-[#0d1117] text-slate-200 border border-[#202428]">
  ...
  <form on:submit={handleSubmit} class="space-y-4">
    ...
    <div>
      ...
      <textarea bind:value={message} rows="6" class="w-full px-4 py-3 rounded-lg bg-[#071019] border border-[#1f2a2f] text-slate-200 pixelify-sans" placeholder="How can we help?"></textarea>
    </div>
